            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div className="md:col-span-2">
                    <div className="mb-6 max-w-[240px]">
                        <img src="/nexdrive-logo.png" alt="NexDrive Academy Logo" className="w-full h-auto drop-shadow-md opacity-90" />
                    </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 font-light text-sm">
                        <li><a href="#" className="hover:text-blue transition-colors">Why NexDrive?</a></li>
                        <li><a href="#" className="hover:text-blue transition-colors">Book a Lesson</a></li>
                        <li><a href="#" className="hover:text-blue transition-colors flex items-center gap-2"><Shield size={14} /> Secure Portal</a></li>
                    </ul>
                </div>

            </div>

            <div className="max-w-7xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs font-data text-white/30">
                <p>&copy; {new Date().getFullYear()} NexDrive Academy. All rights reserved.</p>
