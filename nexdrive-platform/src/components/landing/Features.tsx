    ...
    <section id="approach" className="relative z-20 py-32 px-6 md:px-16 max-w-7xl mx-auto">
      <div className="mb-20 text-center max-w-4xl mx-auto">
        <h2 className="font-heading font-black italic text-4xl md:text-6xl text-white mb-6">
          What We <span className="text-accent">Train</span>
        </h2>
        <p className="text-white/60 text-lg md:text-xl leading-relaxed">
          You learn <span className="text-accent">judgment</span>—reading the road, understanding decisions, and recognising patterns for safe driving.
        </p>
      </div>
  ...
  return (
    <div className="bg-primary border-t border-l border-white/10 border-b-2 border-r-2 border-b-blue/30 border-r-blue/30 rounded-[2rem] p-8 h-[28rem] flex flex-col relative overflow-hidden shadow-[10px_10px_30px_rgba(0,0,0,0.5)]">
      <div className="flex items-center gap-2 text-blue mb-8">
        ...
        <span className="text-data text-xs uppercase tracking-wider text-blue font-semibold">Real Skills</span>
      </div>
      ...
      <div className="mt-auto pt-6 border-t border-white/10">
        ...
        <p className="text-sm text-white/60">You learn judgment—understanding decisions and recognising patterns for safe driving.</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-primary border-t border-l border-white/10 border-b-2 border-r-2 border-b-blue/30 border-r-blue/30 rounded-[2rem] p-8 h-[28rem] flex flex-col relative overflow-hidden shadow-[10px_10px_30px_rgba(0,0,0,0.5)]">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-2 text-blue font-semibold">
          ...
          <span className="text-data text-xs uppercase tracking-wider">Real Confidence</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-accent animate-pulse" />
          <span className="text-data text-[10px] text-accent/80 uppercase">Live Feed</span>
        </div>
      </div>
      ...
      <div className="mt-auto pt-6 border-t border-white/10">
        ...
        <p className="text-sm text-white/60">When you know <em>why</em> you&apos;re doing something, you drive with absolute certainty.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-primary border-t border-l border-white/10 border-b-2 border-r-2 border-b-blue/30 border-r-blue/30 rounded-[2rem] p-8 h-[28rem] flex flex-col relative overflow-hidden shadow-[10px_10px_30px_rgba(0,0,0,0.5)]">
      <div className="flex items-center gap-2 text-blue font-semibold mb-8">
        ...
        <span className="text-data text-xs uppercase tracking-wider">Deliberate Practice</span>
      </div>
