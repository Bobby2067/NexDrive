...
**v1.1 — 24 February 2026**  
Corrected three instances of incorrect/invented content in knowledge base seed examples: (1) FAQ chunker code comment and (2) §20.3 FAQ content format example both cited "30-60 hours of professional instruction" — this figure has no legislative basis and is misleading. The ACT logbook pathway requires a minimum of 7 hours with a licensed ADI (legislative minimum); total supervised logbook requirements are 100 hours (10 night) for under-25s and 50 hours (5 night) for 25+. FAQ example updated to ground the answer in correct ACT requirements. (3) §20.3 regulation summary example cited "Task 3: Steering and Wheel Control" — incorrect task name from the old task list. Corrected to "Task 3: Starting Up Procedure" per NI2020-703 (matching SPEC-01 v1.1 and SPEC-13 v2.3 seed data).
 ...
 *   A: Every learner is different. In the ACT, you need a minimum of 7 hours
 *      with a licensed ADI for the CBT&A logbook pathway. Total supervised
 *      logbook hours required are 100 (10 night) for under-25s, or 50 (5 night)
 *      for 25+. Most students take more than the minimum.
 *   
...
A: Every learner is different — there's no single answer. What the ACT law does require
is a minimum of 7 hours with a licensed ADI (like Rob) as part of the CBT&A logbook
pathway. You also need to complete your logbook: 100 hours supervised driving including
10 hours at night if you're under 25, or 50 hours (5 night) if you're 25 or over.
Most students find they need more than the legal minimum to feel genuinely confident.
Rob will give you an honest assessment of where you're at as you progress.
```
...
Description: The learner demonstrates the correct start-up sequence — checking gear
selector (Neutral/Park), confirming handbrake is applied, then starting the ignition.
For manual vehicles: clutch depressed before ignition. Sequence must be consistent
and correct before each drive...
```
